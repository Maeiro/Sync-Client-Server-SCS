...
> [!NOTE]
> This is the **Fabric branch** of SCS (target: Fabric `1.20.1`).
> - Use `./gradlew runClient` (or `.\\gradlew.bat runClient`) to run in dev environment.
> - Metadata source is `src/main/Resources/fabric.mod.json`.
> - NeoForge metadata (`neoforge.mods.toml`) is not used in this branch.
